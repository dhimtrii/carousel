...
<body>
	...
	<section id="main" class="column mainDiv">
		...
		<article class="module width_3_quarter medication" style="width:95% !important;">
			...
			<div class="tab_container" style="height:680px;">
				<div id="tab1" class="tab_content" id="patient_medication" style="min-height:680px;height:auto;">
					
					<div data-role="content" id="contentMed" class="patient_medication overflow" style="min-height:680px;height:auto;">
						<!-- Edit medication -->
						<div data-role="page" id="medication_edit">
							...
							<div id="medicationHeaderEdit" class="float100"> 
								...
								<a class="grayButton cancelMedication" id="cancelAddMed"  onclick="resetFields()"> Reset </a>
								<a class="grayButton cancelMedication" id="cancelEditMed"  onclick="resetFields()"> Reset </a>
