...
<body>
	...
	<section id="main" class="column mainDiv">
		...
		<article class="module width_3_quarter medication" style="width:95% !important;">
			<header>
				<h3 class="subHeader">
				<span class="vaccnViewHeader fl textCenter underline" id="vaccnHeader" style="width:50%;cursor:pointer;">Add Vaccination</span>
			...
			<div class="tab_container">
				<div id="tab1" class="tab_content" id="patient_medication" style="height:550px;">
					<div style="width:100%;display:inline-flex;border-bottom:2px solid;padding-bottom:3px;">
					...
					<div data-role="content" id="contentVaccn" class="patient_vaccination patient_medication overflow" style="height:550px;">
					
					</div>
				</div>
				
				<div id="tab2" class="tab_content" id="patient_medication" style="height:550px;">
					<div style="width:100%;display:inline-flex;border-bottom:2px solid;padding-bottom:3px;">
						<img src="<?php echo base_url()?>images/prev_arrow.png" id="leftMenu" class="fl prevArrow" onclick="prevChild()"/>
						<h3 id="childNameContent" style="width:85%;text-align:center; color:#000;"></h3>
						<img src="<?php echo base_url()?>images/next_arrow.png" id="rightMenu" class="fr nextArrow"  onclick="nextChild()"/>
					</div>
					<div data-role="content" id="contentChildVaccn" class="patient_vaccination patient_medication overflow" style="height:550px;">
