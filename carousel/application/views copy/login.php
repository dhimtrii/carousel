        ...
        <div style="width:100%;height:100%">
            ...
            <div class="rightBodyPortion fr">
                ...
                <div class="userNameBox auto">
                    <span class="labelBox">UserName: </span><input class="fr inputBox" type="textbox" id="username" value=""/>
                </div>
                <div class="passwordBox auto">
                    <span class="labelBox">Password:</span> <input class="fr inputBox" type="password" id="password" value=""/>
                </div>
                                <input type="hidden" value="<?php echo $this->session->userdata('privKey'); ?>"/>

                <div style="cursor:pointer;float:left !important;margin-left:60% !important;margin-top:35px;padding: 2% 5%;" id="signIn" class="underline medicationSaveButton blueButton">Sign In</div>
