...
<body>
	...
	<section id="main" class="column mainDiv">
		...
		<article class="module width_3_quarter medication" style="width:95% !important;height:500px;">
			<header>
							<h3 id="hexagonMed" style="width:85%;text-align:center;">Add Vaccination</h3>
				
			</header>

			<div class="tab_container" style="height:500px;">
				<div id="tab1" class="tab_content" id="patient_medication" style="height:500px;">
					
					<div data-role="content" id="contentMed" class="patient_medication overflow" style="height:500px;">
						<div id="addVaccn" class="width80 auto">
							<div style="display:block;margin-top:30px;" class="medicationOperation"> 
							    
							    <div class="saveMedicationOperation"><a onclick="return false;" class="grayButton cancelMedication" id="cancelVaccn" href="javascript:void(0);" onclick="closeVaccination()"> Cancel </a> <a onclick="savePatientVaccination();return false;" style="padding:8px 20px;" class="medicationSaveButton blueButton" href="javascript:void(0);"> Save </a> </div> 
							</div> 
							<br/>
							...
							<div style="display:block;padding-top:100px;" class="vaccnField">    
								...
								<div class="fr width60">
								    ...
								    <input type="text" id="vaccnTitile" class="width100 font16 required" value=""/>
								</div>
							    </div>
								...
								<div class="fr width60">
								    <input type="text" id="scdlTime" class="timepicker width100 font16 required" value="" readonly/>
								</div>
							    </div>
								...
								<div class="fr width60">
								   <textarea rows="7" cols="26" id="vaccnDesc" class="font16 required"></textarea>
								</div>
							    </div>
							</div>
						</div>
