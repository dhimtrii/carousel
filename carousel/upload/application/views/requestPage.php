...
<body>
	...
	<header id="header">
		<hgroup>
			...
			<h2 class="section_title">Send Request</h2>
		</hgroup>
	...
	<section id="main" class="column mainDiv">
		...
		<article class="module width_3_quarter medication" style="width:95% !important;">
			<header>
				<h3 id="hexagonMed" style="width:85%;text-align:center;">Send Request</h3>
			...
			<div class="tab_container">
				<div id="tab1" class="tab_content" id="patient_medication">
					...
					<div data-role="content" id="contentRequest" class="patient_medication overflow">
