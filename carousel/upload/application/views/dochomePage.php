...
<head>
    ...
    $(document).ready(function(){
      ...
      $.post("home/getalldocdata", { "docId": 125 },
                        function(data){
	...
	$.post("home/getallpatient", { "userId": 125 },
                        function(data){
                          //alert(data.username); // John
...
<body>
	...
	<div id="docDashboard">
		<h4 class="alert_info">Welcome Jonney Arrien</h4>
		
		<article class="module width_full stats">
			<header><h3>Shared Files</h3><img src="../images/collapse.png" id="patient_stats_div "class="fr collapse" style="margin-top:9px;margin-right:10px;"/></header>
		...
		<article class="module width_full appointments">
			<header><h3>Sharing Request</h3><img src="../images/collapse.png" id="patient_appt_div "class="fr collapse" style="margin-top:9px;margin-right:10px;"/></header>
