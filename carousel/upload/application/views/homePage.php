...
<head>
	...
	<!-- graph Library-->
	<link rel="stylesheet" type="text/css" href="<?php echo base_url()?>styles/jquery.jqChart.css" />
	<link rel="stylesheet" type="text/css" href="<?php echo base_url()?>styles/jquery.jqRangeSlider.css" />
	<script src="<?php echo base_url()?>scripts/jquery.mousewheel.js" type="text/javascript"></script>
	<script src="<?php echo base_url()?>scripts/jquery.jqChart.min.js" type="text/javascript"></script>
	<script src="<?php echo base_url()?>scripts/js/jquery.jqRangeSlider.min.js" type="text/javascript"></script>
