...
<head>
    ...
    $(function(){
        var date = new Date();
	       ...
	       openDashboardMed();
                $.post("vaccination/viewvaccn", { "patientId": 5 },
                        function(data){
	...
	<section id="main" class="column mainDiv">
		...
		<article class="module width_3_quarter medication" style="width:95% !important;">
			<header>
							...
							<h3 id="hexagonVaccn" style="width:85%;text-align:center;">Patient Vaccination</h3>
			...
			<div class="tab_container">
				<div id="tab1" class="tab_content" id="patient_medication">
					...
					<div data-role="content" id="contentVaccn" class="patient_vaccination patient_medication overflow">
