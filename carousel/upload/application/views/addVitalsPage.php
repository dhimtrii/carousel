		...
		<article class="module width_3_quarter medication" style="width:95% !important;">
			...
			<div class="tab_container">
				<div id="tab1" class="tab_content" id="patient_medication">
					...
					<div data-role="content" id="contentaddVit" class="patient_medication overflow" style="height:550px !important;">
						...
						<div class="" style="width:55%;margin-left:auto;margin-right:auto;margin-top:100px;">
							<div class="fl actionLabel">Vitals: </div>
							<div class="fl width60">
							    <select class="w100 font16" data-theme="a" name="select-choice-1" id="vitTitile" onchange="changeVital()">
