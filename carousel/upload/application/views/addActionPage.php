	...
	<section id="main" class="column mainDiv">
		...
		<article class="module width_3_quarter medication" style="width:95% !important;height:auto;margin-bottom:50px;">
			...
			<div class="tab_container">
				<div id="tab1" class="tab_content" id="patient_medication" style="height:650px;">
					
					<div data-role="content" id="contentMed" class="patient_medication overflow" style="height:650px;">
						<div id="addEditActionForm" class="block float100 scroll">
							...
							<div id="actionOpHeader" class="float100">
								...
								<a class="grayButton cancelMedication fr" style="color:#000 !important;" id="cancelActionEdit" onclick="cancelPatientAction()"> Cancel </a>
							...
							<div id="addEditActionContent">
								...
								<div class="float100 actionContentTr">
									...
									<select id="exerciseSelectName" class="actionSelectInput" data-role="none">
									...
									<div class="actionInput">
									    <input type="tel" id="exerciseDuration" maxlength="3" class="editActionInput"> min
									</div>
								    </div>
								    <div class="float100 actionContentTr">
									<div class="actionLabel">Type:</div>
									<div class="actionInput">
									    <select id="exerciseSelectType" class="actionSelectInput" data-role="none">
									...
									<div class="actionInput">
									    <input type="text" class="actionDate editActionInput" id="exerciseFromDate" readonly="readonly">
									</div>
								    </div>
								    <div class="float100 actionContentTr">
									<div class="actionLabel">To:</div>
									<div class="actionInput">
									    <input type="text" class="actionDate editActionInput" id="exerciseToDate" readonly="readonly">
									</div>
								    </div>
								    <div class="float100 actionContentTr">
									<div class="actionLabel">Frequency:</div>
									<div class="actionInput">
									    <input type="tel" id="exerciseFrequency" class="editActionInput" maxlength="1">
									    <div id="exerciseTime">   
									    </div>
									</div>
								    </div>
